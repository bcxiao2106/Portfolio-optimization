    ...
    for i, c in enumerate(Clauses):
        ...
        for l in c:
          if l >= n:
              ...
              clause.append(Lit[l])
        model.addGenConstrOr(Cla[i], clause, "CNSTR_Clause" + str(i))

    # Link objs with clauses
    model.addGenConstrMin(Obj0, Cla, name="CNSTR_Obj0")
    model.addGenConstrIndicator(Obj1, 1, Cla.sum() >= 4.0, name="CNSTR_Obj1")
