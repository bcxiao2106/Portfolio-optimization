...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if($_POST["pflo_name"] != "" || $_POST["pflo_name"] != null){
		...
		if($result->num_rows > 0){//existing name
			...
			echo "alert(\"Name occupied!\");";
			echo "location.href=\"creat_portfolio.php\";";
			echo"</script>";
		} else {//creat new portfolio
			$sql = "insert into portfolio (pflo_name,user_id) values ('$pflo_name', $user_id)";
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<script language="javascript">
		function checkForm(){
			var pflo_name = document.forms["createPfloFrm"]["pflo_name"].value;
...
-->
  ...
  <body>
  <br>
   	<form class="form-group" name="createPfloFrm" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
   <div class="form-group" align="center">
   	<input type="text" placeholder="pflo_name" class="form-control" name="pflo_name">
	</div>
	<div class="form-group" align="center">
